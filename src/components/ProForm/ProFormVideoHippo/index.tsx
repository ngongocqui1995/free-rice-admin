...
const ProFormVideoHippo: React.FC<ProFormVideoProps> = ({ form }) => {
  const intl = useIntl();
    ...
    <Form.Item label={intl.formatMessage({ id: 'pages.video', defaultMessage: 'Video' })}>
      <div className="flex flex-nowrap space-x-1">
        <div className="flex-auto">
          <Form.Item
            name="video"
            help="Định dạng 'https://daochichteam1230.hippovideo.io/video/play/1111111'"
          >
            <Input
...
export default ProFormVideoHippo;
